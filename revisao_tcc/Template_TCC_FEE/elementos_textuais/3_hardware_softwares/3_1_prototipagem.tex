...
\begin{figure}[!h]
	...
	\efbox{\includegraphics[width=0.5\textwidth]{Capitulos/3_hardware_softwares/3_figuras/f4_ponteH.pdf}}
	\caption*{Fonte: elaborado pelo autor (2023).}
	\label{fig3:image_07}
\end{figure}
...
\begin{figure}[!h]
	...
	\efbox{\includegraphics[width=0.6\textwidth]{Capitulos/3_hardware_softwares/3_figuras/f1_braco_aerop.pdf}}
	\caption*{Fonte: elaborado pelo autor (2023).}
	\label{fig3:image_08}
\end{figure}
...
%         \centering
%         \caption{Resistores.}
%         \efbox{\includegraphics[width=\textwidth, page=1]{Capitulos/3_hardware_softwares/3_figuras/res_cap.pdf}}
%         \caption*{Fonte: elaborado pelo autor (2023).}
%         \label{fig3:image_09}
%     \end{subfigure}
%     \hfill
...
%         \centering
%         \caption{Capacitores.}
%         \efbox{\includegraphics[width=\textwidth, page=2]{Capitulos/3_hardware_softwares/3_figuras/res_cap.pdf}}
%         \caption*{Fonte: elaborado pelo autor (2023).}
%         \label{fig3:image_10}
%     \end{subfigure}
%\end{figure}
